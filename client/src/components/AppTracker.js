...
export default function withGraphQLTracking(ComposedComponent) {
    class WithGraphQLTracking extends Component {
        render() {
            return <ComposedComponent {...this.props} />;
        }
    };

    WithGraphQLTracking.displayName = `WithGraphQLTracking(${ComposedComponent.displayName || ComposedComponent.name || 'Component'})`;
