...
export default class WadayanoScore extends Component{
    ...
    return(<React.Fragment><div className="columns is-gapless is-multiline" style={{margin:"0px"}}>
        ...
        <div><span className="subtitle is-4">{emojis[this.props.confidenceText]} {this.props.confidenceText}</span><a className="question-mark-circle" onClick = {() => this.helpText()}>?</a></div></div>
        </div>
