      ...
      <main>
        ...
        <div className="container welcome-page">
          ...
          <div className="section tile is-ancestor">
            ...
            <div className="tile is-parent">
              <article className="tile is-child box">
                ...
                <p className="content">
                  Students estimate how well they know each quiz concept and indicate whether they
                  are confident in their response to each question.
                  <br />
                  <br />
            ...
            <div className="tile is-parent">
              <article className="tile is-child box">
                ...
                <p className="content">
                  Review predicted and wadayano scores by quiz and concept to see where students
                  over- and underestimate their own knowledge.
                  <br />
                  <br />
          ...
          <section className="section" style={{ marginTop: '-2rem', paddingTop: 0 }}>
            ...
            sense of what you do and don’t know enables you to develop plans and strategies that
            make effective use of limited study time and resources.&nbsp;
