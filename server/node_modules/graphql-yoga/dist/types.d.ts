...
export interface Props<TMiddlewareSource = any, TMiddlewareContext = any, TMiddlewareArgs = any> {
    ...
    mocks?: IMocks;
    middlewares?: IFieldMiddleware<TMiddlewareSource, TMiddlewareContext, TMiddlewareArgs>[];
}
